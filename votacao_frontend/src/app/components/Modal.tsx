...
export default function Modal({ children, onConfirm, onCancel }: TModalProps) {
  return (
    <div className="fixed inset-0 z-[1000] flex h-screen w-screen items-center justify-center bg-black/50">
      <div className="flex w-[400px] max-w-[90%] flex-col gap-4 rounded-lg bg-[var(--color-light)] p-6 px-8 text-center text-[var(--color-dark)] shadow-[0_10px_25px_rgba(0,0,0,0.2)]">
        {children}
